...
(function () {
  ...
  function renderPill(state, data = {}) {
    ...
    if (state === "email_ready") {
      ...
      container.innerHTML = `
        <div class="spark-otp-card">
          ...
          <div class="spark-otp-actions">
            ...
            <button class="spark-otp-btn spark-otp-btn-ghost" id="spark-btn-mute-domain" title="${t("disableSite")}">🚫</button>
      ...
      const muteBtn = document.getElementById("spark-btn-mute-domain");
      if (muteBtn) {
